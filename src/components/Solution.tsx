...
const Solution = () => {
  ...
  const UnifiedVisual = () => (
    <div className="h-full flex flex-col p-5 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent -translate-x-full animate-[shimmer_3s_ease-in-out_infinite] md:animate-none pointer-events-none" />
        ...
        <div className="bg-white/10 border border-accent/30 rounded-xl p-4 animate-[cardGlow_3s_ease-in-out_infinite] md:animate-none">
          <div className="flex items-start gap-3 mb-3">
            <div className="w-10 h-10 rounded-full bg-accent/10 flex items-center justify-center text-sm font-bold text-accent relative">
              <div className="absolute inset-0 rounded-full bg-accent/20 animate-ping md:animate-none opacity-75" style={{ animationDuration: '2s' }} />
              JD
            </div>
          ...
          <div className="space-y-2">
            {[
              ...
              <div 
                key={i} 
                className="flex items-center justify-between p-2 bg-white/10 rounded-lg animate-[float_3s_ease-in-out_infinite] md:animate-none"
                style={{ animationDelay: `${i * 0.2}s` }}
              >
                <div className="flex items-center gap-2">
                  <item.icon className="w-3.5 h-3.5 text-accent/70 animate-pulse md:animate-none" style={{ animationDelay: `${i * 0.3}s` }} />
                  <span className="text-[10px] text-white/60">{item.label}</span>
                </div>
                <div className="text-right">
                  <div className="text-[10px] text-white">{item.value}</div>
                  <div className="text-[9px] text-accent animate-[shimmer_2s_ease-in-out_infinite] md:animate-none" style={{ animationDelay: `${i * 0.15}s` }}>{item.status}</div>
                </div>
              </div>
            ))}
          </div>
    ...
    <div className="h-full flex flex-col p-5 relative overflow-hidden">
      ...
      <div className="flex-1 space-y-2 relative z-10">
        {[
          ...
          <div 
            key={i} 
            className={`p-3 rounded-lg border animate-[float_3s_ease-in-out_infinite] md:animate-none ${
          ...
          >
            <div className="flex items-center justify-between mb-1">
              <div className="flex items-center gap-2">
                {auto.status === 'escalated' ? (
                  ...
                  <CheckCircle className="w-3.5 h-3.5 text-accent/70 animate-pulse md:animate-none" style={{ animationDelay: `${i * 0.2}s` }} />
                )}
                <span className="text-[11px] font-medium text-white">{auto.name}</span>
              </div>
              <span className={`text-[9px] px-1.5 py-0.5 rounded animate-[shimmer_2s_ease-in-out_infinite] md:animate-none ${
                auto.status === 'escalated' 
            ...
            <div className="flex items-center gap-1 text-[9px] text-white/60 pl-5">
              <Eye className="w-3 h-3 animate-pulse md:animate-none" style={{ animationDelay: `${i * 0.25}s` }} />
              {auto.reason}
            </div>
          </div>
        ))}
      ...
      <div className="mt-4 pt-3 border-t border-white/20 flex items-center justify-between relative z-10">
        ...
        <div className="flex items-center gap-1.5 px-2 py-1 bg-accent/10 rounded-full animate-[cardGlow_2s_ease-in-out_infinite] md:animate-none">
          <Zap className="w-3 h-3 text-accent animate-[bounce_1s_ease-in-out_infinite] md:animate-none" />
