...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen pb-16 md:pb-8 px-[3px] md:px-12 lg:px-4 pt-24 md:pt-32 relative overflow-hidden">
      {/* Background */}
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-16 items-center">
          <div className="space-y-4 md:space-y-8">
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-semibold tracking-tight leading-[1.1] text-foreground fade-in">
              <span className="md:hidden">AI that handles calls, texts, and bookings — so customers keep coming back.</span>
