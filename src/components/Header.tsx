...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-xl md:backdrop-blur-sm border-b border-white/[0.08] md:border-border/20 md:bg-background/80">
      {/* Mobile: Dark header for dark hero */}
      <div className="md:hidden absolute inset-0 bg-black/95 backdrop-blur-xl" />
