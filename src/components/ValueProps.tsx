    ...
    <div className="relative w-full h-full flex flex-col p-3 md:p-5">
      ...
      <div className="flex items-center justify-between mb-2 md:mb-4 fade-in">
        <div className="flex items-center gap-1.5 md:gap-2">
          ...
          <span className="text-[10px] md:text-xs text-muted-foreground uppercase tracking-wider">Live Leads</span>
        </div>
      ...
      <div className="flex-1 space-y-2 md:space-y-3 overflow-hidden">
        {[
          ...
          <div 
            key={i} 
            className="bg-card/80 border border-border/50 rounded-lg md:rounded-xl p-2 md:p-3 fade-in hover:border-accent/30 transition-colors"
          ...
          >
            ...
            <div className="flex items-center justify-between mb-1.5 md:mb-2">
              <div className="flex items-center gap-1.5 md:gap-2">
                ...
                <div>
                  <div className="text-[10px] md:text-xs font-medium text-foreground">{lead.name}</div>
                  <div className="text-[8px] md:text-[10px] text-muted-foreground">{lead.source} · {lead.time}</div>
                </div>
              </div>
            ...
            {/* Request */}
            <div className="bg-muted/30 rounded-md md:rounded-lg px-1.5 md:px-2 py-1 md:py-1.5 mb-1.5 md:mb-2">
              <p className="text-[9px] md:text-[11px] text-foreground truncate">"{lead.request}"</p>
            </div>
            ...
            <div className="mt-1.5 md:mt-2 pt-1.5 md:pt-2 border-t border-border/30 flex items-center justify-between">
      ...
      {/* Summary stats */}
      <div className="mt-2 md:mt-4 pt-2 md:pt-3 border-t border-border/30 flex items-center justify-between fade-in" style={{ animationDelay: '0.5s' }}>
        <div className="flex items-center gap-2 md:gap-4">
          <div className="text-center">
            <div className="text-sm md:text-base font-bold text-accent">$850</div>
            <div className="text-[7px] md:text-[8px] text-muted-foreground">Today</div>
          </div>
          <div className="w-px h-4 md:h-6 bg-border/50" />
          <div className="text-center">
            <div className="text-sm md:text-base font-bold text-foreground">100%</div>
            <div className="text-[7px] md:text-[8px] text-muted-foreground">Answered</div>
          </div>
          <div className="w-px h-4 md:h-6 bg-border/50" />
          <div className="text-center">
            <div className="text-sm md:text-base font-bold text-foreground">3/3</div>
            <div className="text-[7px] md:text-[8px] text-muted-foreground">CRM synced</div>
          </div>
        </div>
  ...
  const RetentionVisual = () => (
    <div className="relative w-full h-full flex flex-col p-3 md:p-5">
      ...
      <div className="flex items-center justify-between mb-2 md:mb-4 fade-in">
        <div className="flex items-center gap-1.5 md:gap-2">
          <div className="w-1.5 md:w-2 h-1.5 md:h-2 rounded-full bg-accent animate-pulse" />
          <span className="text-[10px] md:text-xs text-muted-foreground uppercase tracking-wider">AI Follow-ups</span>
        </div>
          ...
          >
            ...
            <div className="flex items-center justify-between mb-1.5 md:mb-2">
              <div className="flex items-center gap-1.5 md:gap-2">
                ...
                <div>
                  <div className="text-[10px] md:text-xs font-medium text-foreground">{customer.name}</div>
                  <div className="text-[8px] md:text-[10px] text-muted-foreground truncate max-w-[80px] md:max-w-none">{customer.vehicle}</div>
                </div>
              </div>
              <div className={`text-[8px] md:text-[10px] px-1 md:px-1.5 py-0.5 rounded font-medium ${
            ...
            {/* Context */}
            <div className="text-[8px] md:text-[10px] text-muted-foreground mb-1.5 md:mb-2 flex items-center gap-1">
            ...
            <div className="bg-accent/5 border border-accent/20 rounded-md md:rounded-lg p-1.5 md:p-2 mb-1.5 md:mb-2">
              <div className="flex items-start gap-1.5 md:gap-2">
                ...
                <p className="text-[9px] md:text-[11px] text-foreground/90 leading-relaxed line-clamp-2">"{customer.message}"</p>
              </div>
            </div>
            ...
            {customer.response && (
              <div className="flex justify-end">
                <div className="bg-muted/50 rounded-md md:rounded-lg px-1.5 md:px-2 py-1 md:py-1.5 max-w-[70%]">
                  <p className="text-[9px] md:text-[11px] text-foreground">"{customer.response}"</p>
                </div>
              </div>
            )}
            ...
            {customer.outcome === 'Booked' && (
              <div className="mt-1.5 md:mt-2 pt-1.5 md:pt-2 border-t border-border/30 flex items-center justify-between">
                <span className="text-[8px] md:text-[10px] text-muted-foreground">Revenue recovered</span>
      ...
      <div className="mt-2 md:mt-4 pt-2 md:pt-3 border-t border-border/30 flex items-center justify-between fade-in" style={{ animationDelay: '0.5s' }}>
        <div className="flex items-center gap-2 md:gap-4">
          <div className="text-center">
            ...
            <div className="text-[7px] md:text-[8px] text-muted-foreground">Recovered</div>
          </div>
          <div className="w-px h-4 md:h-6 bg-border/50" />
          <div className="text-center">
            <div className="text-sm md:text-base font-bold text-foreground">67%</div>
            <div className="text-[7px] md:text-[8px] text-muted-foreground">Response rate</div>
          </div>
        </div>
        <div className="flex items-center gap-1 md:gap-1.5 px-1.5 md:px-2 py-0.5 md:py-1 bg-accent/10 rounded-full">
          <div className="w-1 md:w-1.5 h-1 md:h-1.5 rounded-full bg-accent animate-pulse" />
  ...
  const AutomationVisual = () => (
    <div className="relative w-full h-full flex flex-col p-3 md:p-5">
      ...
      <div className="flex items-center justify-between mb-2 md:mb-4 fade-in">
        <div className="flex items-center gap-1.5 md:gap-2">
          <div className="w-1.5 md:w-2 h-1.5 md:h-2 rounded-full bg-accent animate-pulse" />
          <span className="text-[10px] md:text-xs text-muted-foreground uppercase tracking-wider">CRM Dashboard</span>
        </div>
      ...
      <div className="flex-1 space-y-2 md:space-y-3 overflow-hidden">
        ...
        <div className="bg-card/80 border border-accent/30 rounded-lg md:rounded-xl p-2.5 md:p-4 fade-in">
          <div className="flex items-start gap-2 md:gap-3 mb-2 md:mb-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between gap-1">
                <div className="text-[11px] md:text-sm font-medium text-foreground truncate">John Davidson</div>
                <div className="text-[8px] md:text-[10px] px-1 md:px-1.5 py-0.5 bg-accent/20 text-accent rounded flex-shrink-0">VIP</div>
              </div>
              <div className="text-[8px] md:text-[10px] text-muted-foreground truncate">2021 Tesla Model 3</div>
            </div>
          </div>
          
          {/* Customer stats */}
          <div className="grid grid-cols-3 gap-1.5 md:gap-2 mb-2 md:mb-3">
            <div className="text-center p-1.5 md:p-2 bg-muted/30 rounded-md md:rounded-lg">
              <div className="text-[11px] md:text-sm font-bold text-foreground">8</div>
              <div className="text-[7px] md:text-[9px] text-muted-foreground">Visits</div>
            </div>
            <div className="text-center p-1.5 md:p-2 bg-muted/30 rounded-md md:rounded-lg">
              <div className="text-[11px] md:text-sm font-bold text-accent">$1,440</div>
              <div className="text-[7px] md:text-[9px] text-muted-foreground">Lifetime</div>
            </div>
            <div className="text-center p-1.5 md:p-2 bg-muted/30 rounded-md md:rounded-lg">
              <div className="text-[11px] md:text-sm font-bold text-foreground">45d</div>
              <div className="text-[7px] md:text-[9px] text-muted-foreground">Avg. cycle</div>
            </div>
          </div>
          
          {/* Recent activity log */}
          <div className="space-y-1">
            <div className="text-[8px] md:text-[10px] text-muted-foreground uppercase tracking-wider mb-1 md:mb-2">Activity Log</div>
            {[
              ...
              <div key={i} className="flex items-center justify-between text-[8px] md:text-[10px] py-0.5 md:py-1 border-b border-border/20 last:border-0">
                <div className="flex items-center gap-1 md:gap-2 min-w-0">
                  ...
                  <span className="text-muted-foreground hidden md:inline">· {log.detail}</span>
                </div>
        ...
        <div className="grid grid-cols-2 gap-1.5 md:gap-2">
          {[
            ...
            <div 
              key={i} 
              className="bg-card/60 border border-border/50 rounded-md md:rounded-lg p-2 md:p-2.5 fade-in hover:border-accent/30 transition-colors"
            ...
            >
              <div className="flex items-center gap-1.5 md:gap-2 mb-1.5 md:mb-2">
                ...
                <div className="min-w-0">
                  <div className="text-[9px] md:text-[11px] font-medium text-foreground truncate">{customer.name}</div>
                  <div className="text-[7px] md:text-[9px] text-muted-foreground truncate">{customer.vehicle}</div>
                </div>
              </div>
              <div className="flex items-center justify-between text-[8px] md:text-[10px]">
      ...
      <div className="mt-2 md:mt-4 pt-2 md:pt-3 border-t border-border/30 flex items-center justify-between fade-in" style={{ animationDelay: '0.5s' }}>
        <div className="flex items-center gap-2 md:gap-4">
          <div className="text-center">
            <div className="text-sm md:text-base font-bold text-foreground">142</div>
            <div className="text-[7px] md:text-[8px] text-muted-foreground">Profiles</div>
          </div>
          <div className="w-px h-4 md:h-6 bg-border/50" />
          <div className="text-center">
            <div className="text-sm md:text-base font-bold text-accent">100%</div>
            <div className="text-[7px] md:text-[8px] text-muted-foreground">Up to date</div>
          </div>
          <div className="w-px h-4 md:h-6 bg-border/50" />
          <div className="text-center">
            <div className="text-sm md:text-base font-bold text-foreground">0</div>
            <div className="text-[7px] md:text-[8px] text-muted-foreground">Manual</div>
          </div>
        </div>
        <div className="flex items-center gap-1 md:gap-1.5 px-1.5 md:px-2 py-0.5 md:py-1 bg-accent/10 rounded-full">
          <div className="w-1 md:w-1.5 h-1 md:h-1.5 rounded-full bg-accent animate-pulse" />
